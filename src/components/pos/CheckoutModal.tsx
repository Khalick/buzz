          ...
          <>
            ...
            <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-4xl font-black text-[#A51C30] dark:text-[#B39A74]">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button onClick={() => { setPaymentMethod('cash'); setAmountTendered(''); }}
                    className={`flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all ${paymentMethod === 'cash' ? 'border-[#B39A74] bg-[#FAF8F5] text-[#A51C30] dark:bg-gray-800 dark:text-[#B39A74]' : 'border-gray-200 dark:border-gray-700 text-gray-500 hover:border-[#B39A74]/50'}`}>
                    <Banknote size={28} className="mb-1" />
                    <span className="font-bold text-xs">Cash</span>
                  </button>
                  <button onClick={() => setPaymentMethod('mobile_money')}
                    className={`flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all ${paymentMethod === 'mobile_money' ? 'border-[#B39A74] bg-[#FAF8F5] text-[#A51C30] dark:bg-gray-800 dark:text-[#B39A74]' : 'border-gray-200 dark:border-gray-700 text-gray-500 hover:border-[#B39A74]/50'}`}>
                    <Smartphone size={28} className="mb-1" />
                    <span className="font-bold text-xs">M-Pesa</span>
                  </button>
                  <button onClick={() => setPaymentMethod('card')}
                    className={`flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all ${paymentMethod === 'card' ? 'border-[#B39A74] bg-[#FAF8F5] text-[#A51C30] dark:bg-gray-800 dark:text-[#B39A74]' : 'border-gray-200 dark:border-gray-700 text-gray-500 hover:border-[#B39A74]/50'}`}>
